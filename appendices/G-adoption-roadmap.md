...
- **Start with pain, not with a framework.** Find the thing that hurts most —
  slow releases, frequent outages, failed audits, attrition — and fix that
...
- [ ] Run a lightweight assessment against the maturity models in Appendix D to
...
See **Appendix D** for the maturity models that anchor the assessments, and
**Appendix B** for the launch, review, and audit checklists that operationalize
each step.
