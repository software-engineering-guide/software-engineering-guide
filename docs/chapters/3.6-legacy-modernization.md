...
- **You cannot modernize what you do not understand.** [Reverse-engineer](https://en.wikipedia.org/wiki/Reverse_engineering) and document behavior (including undocumented rules) before replacing it.
